# Reser - ПРОГРАММА ДЛЯ ИЗУЧЕНИЯ КОЛЕБАТЕЛЬНОЙ СИСТЕМЫ 'ДЕРИВАЦИЯ - УРАВНИТЕЛЬНЫЙ РЕЗЕРВУАР С ДОПОЛНИТЕЛЬНЫМ СОПРОТИВЛЕНИЕМ'
...
### Windows
Для Windows x64 скачайте "свежий" (Latest) релиз [Setup_Reser_vXXXX.X_Win.exe](https://github.com/electronik779/Reser/releases) и установите, выбрав опцию "для всех пользователей".
...
<img width="784" height="622" alt="image" src="https://github.com/user-attachments/assets/c36d468a-023f-4142-9811-0e0d161e51c5" />
...
Группа **Закон изменения расхода**:
...
Результаты расчета, показываются на графиках справа. Над графиками выводится значение максимального давления в деривации под резервуаром (при определении максимального уровня) и значения максимального и минимального уровней в резервуаре.
